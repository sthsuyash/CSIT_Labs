...
//        stackPane.getChildren().addAll(button1, button2, button3, button4, label1);
//
//        // Center the buttons and label in the StackPane
//        StackPane.setAlignment(button1, Pos.TOP_LEFT);
//        StackPane.setAlignment(button2, Pos.TOP_RIGHT);
