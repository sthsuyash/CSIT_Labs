 ...
 * JDBC Connection                                                                                         *
 * ------------------------------------------------------------------------------------------------------- *
 * To connect with external data sources such as XML files, SQL Server, etc., a JDBC driver is required.   *
 * For MySQL connections, the `mysql-connector` JAR needs to be downloaded and added to the project.       *
 * For PostgreSQL, the `postgresql` JAR needs to be downloaded.                                            *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * Steps to connect to the database:                                                                       *
 * 1. Insert the JDBC driver (JAR file) into the project.                                                  *
 * 2. Initialize the driver using `Class.forName("com.mysql.jdbc.Driver");`.                               *
 * 3. Use a connection object to connect to the database. Use `DriverManager.getConnection()` which takes  *
 * three parameters: (protocol, server username, server password).                                         *
 * 4. Write the appropriate SQL query.                                                                     *
 * 5. Execute the query using a `Statement` object.                                                        *
 * 6. Close the connection.                                                                                *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * For insert, update, and delete operations:                                                              *
 * - Use `execute()`: returns `true` or `false`.                                                           *
 * - Use `executeUpdate()`: returns the number of affected rows (1 for success, 0 for no change).          *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * For select operations:                                                                                  *
 * - Use `executeQuery()`: returns a `ResultSet` object.                                                   *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 */
...
class JDBCImpl {
    ...
    /**
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     * Insert data into the table by taking input from the user  *
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     */
...
/**
 * * * * * * * * * * * * * * * * * * * * *
 * Main class to run the JDBC operations *
 * * * * * * * * * * * * * * * * * * * * *
 */
public class JDBC {
