 ...
 * Array                                                                                         *
 *-----------------------------------------------------------------------------------------------*
 * A collection of similar types of elements under the same variable name having contiguous      *
 * memory locations.                                                                             *
 * Java array is an object that contains elements of a similar data type.                        *
