...
class Form extends JFrame {
    ...
    public void setForm() {
        ...
        *---------------------------------------------------------------------------------------------------------*
        * When a button is pressed, it generates an event known as `ActionEvent`.                                 *
        * To handle this event, an event listener is used.                                                        *
        * A listener is an interface, so all its methods must be implemented.                                     *
        * It contains the `actionPerformed` method, which should be overridden to define the action to be taken.  *
        * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
        */
