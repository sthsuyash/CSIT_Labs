...
/**
 * Menubar is a tab that contains sequence of items known as menu
 * and meny in turn contains list of item that can be selected known as menu item
 *
 * 1. Create menu bar
 * 2. Create menu and menu item for each menu
